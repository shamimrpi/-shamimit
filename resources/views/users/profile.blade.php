        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive" src="{{ URL::to('/') }}/users_photo/{{ Auth::user()->photo }}" alt="User profile picture">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p>
                @if(Auth::user()->profile->note)
                {{Auth::user()->profile->note}}</p>
                @endif
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-9">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#findfriend" data-toggle="tab">Timeline</a></li>
                ...
                <div class="post">
                  ...
                  <div class="post-img" style="text-align: center;">
                    @if($post->thumbnail)
                      ...
                      <img src="{{asset('posts_images/'.$post->thumbnail)}}" class="post-img">
                  ...
                  <ul class="list-inline">
                    <li><a href="https://www.facebook.com/sharer/sharer.php?u=YourPageLink.com&display=popup" class="link-black text-sm"><i class="fa fa-share margin-r-5"></i> Share</a></li>
